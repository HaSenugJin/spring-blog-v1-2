insert into user_tb(username, password, email, created_at) values('ssar', '$2a$10$1NTr4/rhxRdseTxG6vs4Yu3hgIhNEf7/eLrfRC7AAz7M8eZNTsC6C', 'ssar@nate.com', now());
insert into user_tb(username, password, email, created_at) values('cos', '$2a$10$1NTr4/rhxRdseTxG6vs4Yu3hgIhNEf7/eLrfRC7AAz7M8eZNTsC6C', 'cos@nate.com', now());
